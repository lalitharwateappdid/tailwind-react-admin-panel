...
<div className='grid md:grid-cols-2 gap-8'>
                        ...
                        <div>
                            ...
                            <div className=" z-20 bg-transparent dark:bg-form-input">
                                <select onChange={(e) => { setParentCategoryId(e.target.value) }} className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                        ...
                        <div>
                            ...
                            <div className=" z-20 bg-transparent dark:bg-form-input">
                                <select onChange={(e) => { setChildCategoryId(e.target.value) }} className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
