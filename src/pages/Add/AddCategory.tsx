...
const AddCategory = () => {
    ...
    return (
        <>
            ...
            <DefaultLayout>
                <Breadcrumb pageName={
                    toggleForm==false? "Add Category" : "Map Category"
                } />
                <div className='p-2 flex justify-center'>
                    <span className='mr-2 font-semibold'>Add Category</span>    <InputSwitch checked={toggleForm==false? false:true} onChange={(e) => setToggleForm(e.target.value)}/> <span className='ml-2 font-semibold'>Map Category</span>
                </div>
                {
                    toggleForm==false ? 
                    ...
                    <div className="grid lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="flex items-center gap-x-1 ">
                            <InputSwitch className="p-invalid" checked={child} onChange={((e) => setChild(e.target.value))} /> <span>Is This Child Category?</span>
                        </div>
